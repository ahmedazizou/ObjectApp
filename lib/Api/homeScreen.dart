import 'dart:convert';
import 'dart:io';
import 'package:object_detection/Api/liveCamera.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<Map<String, dynamic>> getResponse(File imageFile) async {
    ...
    final imgUploadRequest = http.MultipartRequest(
        "POST",
        Uri.parse(
            "https://max-image-caption-generator-ahmedazizou-dev.apps.sandbox-m2.ll9k.p1.openshiftapps.com/model/predict"));
                                    ...
                                    child: Material(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () {
                                          ...
                                          print(
                                              "clicked captureImageWithCamera()");
                                        },
                                        child: Column(
                                          mainAxisAlignment:
                                              MainAxisAlignment.center,
